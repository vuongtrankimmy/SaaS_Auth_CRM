namespace Rebuilds.Jobs.Configurations
{
    public static class Startup
    {
        internal static WebApplicationBuilder UseConfigurations(this WebApplicationBuilder builder)
        {
            ...
            builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                    ...
                    .AddJsonFile($"{configurationsDirectory}/domain.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)

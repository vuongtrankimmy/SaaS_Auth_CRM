...
var KTChartsWidget10 = function () {
    ...
    return {
        init: function () {
            e("#kt_charts_widget_10_tab_1", "#kt_charts_widget_10_chart_1", [30, 18, 43, 70, 13, 37, 76, 12, 23, 55, 66, 77], !0)
                , e("#kt_charts_widget_10_tab_2", "#kt_charts_widget_10_chart_2", [30, 18, 43, 70, 13, 37, 76, 12, 23, 55, 66, 77], !0)
...
var KTChartsWidget101 = {
    init: function () {
        ! function () {
            var e = document.getElementById("kt_charts_widget_10_chart_11");
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    a = KTUtil.getCssVariableValue("--bs-gray-400"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-success"),
                    i = KTUtil.getCssVariableValue("--bs-primary"),
                    k = KTUtil.getCssVariableValue("--bs-light-primary"),
                    s = {
                        series: [{
                            name: 'Other',
                            type: 'bar',
...
"undefined" != typeof module && (module.exports = KTChartsWidget101), KTUtil.onDOMContentLoaded((function () {
    KTChartsWidget101.init()
}));

var KTChartsWidget102 = {
    init: function () {
        ! function () {
            var e = document.getElementById("kt_charts_widget_10_chart_12");
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    a = KTUtil.getCssVariableValue("--bs-gray-400"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
...
"undefined" != typeof module && (module.exports = KTChartsWidget102), KTUtil.onDOMContentLoaded((function () {
    KTChartsWidget102.init()
}));
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    o.mapPolygons.template.setAll({
                        ...
                        toggleKey: "active",
                        interactive: !0
                    }), am5.ColorSet.new(t, {}), o.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), o.mapPolygons.template.states.create("hover", {

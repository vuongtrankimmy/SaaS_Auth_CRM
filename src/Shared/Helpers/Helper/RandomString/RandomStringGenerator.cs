...
namespace Shared.Helpers.Helper.RandomString
{
    public class RandomStringGenerator
    {
        ...
        /// </summary>
        /// <param name="UseUpperCaseCharacters">If true, use upper case characters.</param>
        /// <param name="UseLowerCaseCharacters">If true, use lower case characters.</param>
        /// <param name="UseNumericCharacters">If true, use numeric characters.</param>
        /// <param name="UseSpecialCharacters">If true, use special characters.</param>
                                     ...
                                     bool UseSpecialCharacters = true)
        {
            ...
            UpperCaseCharacters = "ABCDEFGHIJKLMNPQRSTUVWXYZ".ToCharArray();
            LowerCaseCharacters = "abcdefghijklmnopqrstuvwxyz".ToCharArray();
            NumericCharacters = "123456789".ToCharArray();
